...
course_plan_details.belongsTo(course_plans);
...
course_plan_assessments.belongsToMany(course_plan_details, { through: course_plan_detail_assessments });
course_plan_details.belongsToMany(course_plan_assessments, { through: course_plan_detail_assessments });

course_los.belongsToMany(course_plan_details, { through: course_plan_detail_outcomes });
course_plan_details.belongsToMany(course_los, { through: course_plan_detail_outcomes });

course_plan_references.belongsToMany(course_plan_details, { through: course_plan_detail_refs });
course_plan_details.belongsToMany(course_plan_references, { through: course_plan_detail_refs });
